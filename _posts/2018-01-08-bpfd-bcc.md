...
a Linux system. Because they can't crash the kernel, they are safer than kernel modules and also can be used in
production. [Brendan Gregg has written](http://www.brendangregg.com/ebpf.html) nice tools and given talks showing the
